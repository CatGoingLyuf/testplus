...
!function (t, e) {
    "function" == typeof define && define.amd ? define("p5.sound", ["com/drawing/garden/p5"], function (t) {
        e(t)
    ...
    !function (t, e) {
        ...
        function t(t) {
            var e = t.createBuffer(1, 1, t.sampleRate), i = t.createBufferSource();
    ...
    n = function () {
        ...
        t.prototype.set = function (e, i, n) {
            ...
            for (var e in t) {
                var i = e[0].match(/^[A-Z]$/), n = t[e] === this.constructor;
    ...
    o = function (t) {
        ...
        return t.Emitter = function () {
            ...
            for (var n = 0; n < i.length; n++) {
                var o = i[n], r = t.Emitter.prototype[o];
                e[o] = r
            }
    ...
    r = function (t) {
        function e() {
            ...
            var n = AudioNode.prototype.connect, o = AudioNode.prototype.disconnect;
    ...
    a = function (e) {
        ...
        return t.prototype.getMasterVolume = function () {
            ...
            if ("number" == typeof t) {
                var e = e || 0, i = i || 0, o = n.audiocontext.currentTime, r = n.output.gain.value;
    ...
    u = function () {
        function e(t) {
            ...
            var s = i(e, r), a = new window.ArrayBuffer(44 + 2 * s.length), u = new window.DataView(a);
        ...
        t.prototype.sampleRate = function () {
            ...
            var e = Math.log(t / 440) / Math.log(2), i = Math.round(12 * e) + 69;
            return i
        };
        var r = t.prototype.midiToFreq = function (t) {
            ...
            var e = {A: 21, B: 23, C: 24, D: 26, E: 28, F: 29, G: 31}, i = e[t[0].toUpperCase()], n = ~~t.slice(-1);
            switch (i += 12 * (n - 1), t[1]) {
                case"#":
                    i += 1;
                    break;
        ...
        return t.prototype.soundFormats = function () {
            ...
            if ("string" == typeof e) {
                i = e;
                var n = i.split(".").pop();
                if (["mp3", "wav", "ogg", "m4a", "aac"].indexOf(n) > -1) if (t.prototype.isFileSupported(n)) i = i; else for (var r = i.split("."), s = r[r.length - 1], a = 0; a < o.extensions.length; a++) {
                    var u = o.extensions[a], c = t.prototype.isFileSupported(u);
                    if (c) {
                        s = "", 2 === r.length && (s += r[0]);
                ...
                } else for (var a = 0; a < o.extensions.length; a++) {
                    var u = o.extensions[a], c = t.prototype.isFileSupported(u);
                    if (c) {
                        i = i + "." + u;
                        break
                ...
                var u = e[a].split(".").pop(), c = t.prototype.isFileSupported(u);
                if (c) {
                    i = e[a];
                    break
                }
    ...
    p = function () {
        ...
        "undefined" != typeof i.createStereoPanner ? (t.Panner = function (t, e) {
            ...
            var n = e || 0, o = i.currentTime + n, r = (t + 1) / 2, s = Math.cos(r * Math.PI / 2),
    ...
    h = function () {
        ...
        function i(t) {
            for (var e = [], i = Object.keys(t).sort(), n = 0; n < i.length; n++) for (var o = 0; 10 > o; o++) {
                var r = t[i[n]], s = t[i[n + o]];
                if (r && s) {
                    var a = r.sampleIndex, u = s.sampleIndex, c = u - a;
        ...
        function o(t, e, i, n) {
            for (var o = [], s = Object.keys(t).sort(), a = 0; a < s.length; a++) for (var u = s[a], c = t[u], p = 0; p < c.intervals.length; p++) {
        ...
        var h = c, l = a, f = l.audiocontext, d = u.midiToFreq, m = u.convertToWav;
        t.SoundFile = function (e, i, n, o) {
            ...
            var r = this, s = new t.SoundFile(e, function () {
            ...
            var e = l.audiocontext.currentTime, i = t || 0, n = i + e;
            ...
            if ("sustain" === this.mode || "untildone" === this.mode) this.stopAll(e), this._playing = !1, this.pauseTime = 0, this._paused = !1; else if (this.buffer && this.bufferSourceNode) {
                var i = l.audiocontext.currentTime, n = e || 0;
            ...
            var e = l.audiocontext.currentTime, i = t || 0;
            ...
            if ("number" == typeof t) {
                var n = e || 0, o = i || 0, r = l.audiocontext.currentTime, s = this.output.gain.value;
            ...
            var t = this._lastPos / f.sampleRate, e = this.getVolume();
            ...
            var t = l.audiocontext.currentTime, e = l.soundArray.indexOf(this);
            ...
            var e = t.length, i = t[0].length, n = f.createBuffer(e, i, f.sampleRate);
        ...
        var y = function (t) {
            const e = t.length, i = f.createBuffer(1, t.length, f.sampleRate), n = i.getChannelData(0);
            for (var o = 0; e > o; o++) n[o] = o;
            return i
        };
        t.SoundFile.prototype._initCounterNode = function () {
            var e = this, i = f.currentTime, n = f.createBufferSource();
            ...
            var u = this.buffer.length, c = this.buffer.sampleRate, p = this.buffer, h = [], l = r || .9, f = l,
                d = s || .22, m = a || 200, y = new window.OfflineAudioContext(1, u, c), v = y.createBufferSource();
            v.buffer = p;
            ...
            g.type = "lowpass", v.connect(g), g.connect(y.destination), v.start(0), y.startRendering(), y.oncomplete = function (r) {
                if (self.panner) {
                    var s = r.renderedBuffer, a = s.getChannelData(0);
                    do h = e(a, f), f -= .005; while (Object.keys(h).length < m && f >= d);
                    var u = i(h), c = n(u, s.sampleRate), p = c.sort(function (t, e) {
                        return e.count - t.count
                    }).splice(0, 5);
                    this.tempo = p[0].tempo;
                    var l = 5, y = o(h, p[0].tempo, s.sampleRate, l);
                    t(y)
                }
            }
        };
        ...
        t.SoundFile.prototype.addCue = function (t, e, i) {
            var n = this._cueIDCounter++, o = new g(e, t, n, i);
            ...
            for (var e = t / this.buffer.sampleRate, i = this._cues.length, n = 0; i > n; n++) {
                var o = this._cues[n], r = o.time, s = o.val;
    ...
    l = function () {
        ...
        t.Amplitude = function (t) {
            ...
            var p = this, h = this.stereoVol.reduce(function (t, e, i) {
    ...
    d = function (t) {
        ...
        }, t.extend(t.SignalBase), t.SignalBase.prototype.connect = function (e, i, n) {
    ...
    y = function (t) {
        return t.TimeBase = function (e, i) {
            ...
            n: {
                regexp: /^(\d+)n/i, method: function (t) {
            ...
            "+": {
                regexp: /^\+/, precedence: 2, method: function (t, e) {
                    return t() + e()
                }
            }, "-": {
                regexp: /^\-/, precedence: 2, method: function (t, e) {
                ...
                regexp: /^\*/, precedence: 1, method: function (t, e) {
                    return t() * e()
                }
            }, "/": {
                regexp: /^\//, precedence: 1, method: function (t, e) {
            ...
            function e(t, e) {
                for (var i = ["_binaryExpressions", "_unaryExpressions", "_primaryExpressions", "_syntaxGlue"], n = 0; n < i.length; n++) {
                    var o = e[i[n]];
                    for (var r in o) {
                        var s = o[r], a = s.regexp, u = t.match(a);
                        if (null !== u) return {
                            method: s.method,
            ...
            var e = this._tokenize(t), i = this._parseBinary(e);
            return i
    ...
    v = function (t) {
        return t.Time = function (e, i) {
            ...
            return e = this.defaultArg(e, 1), this._expr = function (t, e, i) {
                t = t(), e = e.toSeconds();
                var n = Math.round(t / e), o = n * e, r = o - t;
                return t + r * i
            ...
            var t = this.toSeconds(), e = ["1m", "2n", "4n", "8n", "16n", "32n", "64n", "128n"],
            ...
            for (var i = this._notationToUnits(e[e.length - 1]), n = "", o = 0; o < e.length; o++) {
                var r = this._notationToUnits(e[o]), s = t / r, a = 1e-6;
    ...
    g = function (t) {
        t.Frequency = function (e, i) {
            ...
            method: function (t, i) {
                var n = e[t.toLowerCase()], o = n + 12 * (parseInt(i) + 1);
            ...
            var e = this.valueOf(), n = Math.log(e / t.Frequency.A4) / Math.LN2, o = Math.round(12 * n) + 57,
                r = Math.floor(o / 12);
            0 > r && (o += -12 * r);
            var s = i[o % 12];
            return s + r.toString()
    ...
    _ = function (t) {
        return t.TransportTime = function (e, i) {
            ...
            regexp: /^@/,
            method: function (e) {
                var i = this._secondsToTicks(e()), n = Math.ceil(t.Transport.ticks / i);
                return this._ticksToUnits(n * i)
            }
        }, t.TransportTime.prototype._secondsToTicks = function (e) {
            var i = this._beatsToUnits(1), n = e / i;
    ...
    O = function () {
        ...
        t.Oscillator = function (i, n) {
            ...
            if (!this.started) {
                var o = i || this.f, r = this.oscillator.type;
            ...
            if (this.started) {
                var i = t || 0, n = e.audiocontext.currentTime;
                this.oscillator.stop(i + n), this.started = !1
            }
        }, t.Oscillator.prototype.amp = function (t, i, n) {
            var o = this;
            if ("number" == typeof t) {
                var i = i || 0, n = n || 0, r = e.audiocontext.currentTime;
            ...
            var n = t.prototype.map(i, 0, 1, 0, 1 / this.f), o = e.audiocontext.currentTime;
        ...
        t.Oscillator.prototype.add = function (t) {
            var e = new i(t), n = this.mathOps.length - 1, o = this.output;
            return r(this, e, n, o, i)
        }, t.Oscillator.prototype.mult = function (t) {
            var e = new n(t), i = this.mathOps.length - 1, o = this.output;
            ...
            var c = new o(a, u), p = this.mathOps.length - 1, h = this.output;
    ...
    F = function (t) {
        ...
        return t.Timeline = function () {
        ...
        }, t.extend(t.Timeline), t.Timeline.defaults = {memory: 1 / 0}, Object.defineProperty(t.Timeline.prototype, "length", {
            get: function () {
            ...
            var e = 0, i = this._timeline.length, n = i;
            if (i > 0 && this._timeline[i - 1].time <= t) return i - 1;
            for (; n > e;) {
                var o = Math.floor(e + (n - e) / 2), r = this._timeline[o], s = this._timeline[o + 1];
                if (r.time === t) {
    ...
    M = function () {
        ...
        t.Envelope = function (t, i, n, o, s, a) {
            ...
            var t = e.audiocontext.currentTime, i = t;
            ...
            var n = e.audiocontext.currentTime, o = i || 0, r = n + o;
            ...
            var r = e.audiocontext.currentTime, s = i || 0, a = r + s, u = this.checkExpInput(n),
    ...
    E = function () {
        ...
        t.Pulse = function (n, o) {
            ...
            var o = i.audiocontext.currentTime, r = n || 0;
            if (!this.started) {
                var s = t || this.f, a = this.oscillator.type;
            ...
            if (this.started) {
                var e = t || 0, n = i.audiocontext.currentTime;
            ...
            if ("number" == typeof t) {
                this.f = t;
                var o = i.audiocontext.currentTime, e = e || 0, n = n || 0, r = this.oscillator.frequency.value;
    ...
    V = function () {
        ...
        var i = function () {
            ...
            var t, i, n, o, r, s, a, u = 2 * e.audiocontext.sampleRate,
                c = e.audiocontext.createBuffer(1, u, e.audiocontext.sampleRate), p = c.getChannelData(0);
            t = i = n = o = r = s = a = 0;
            for (var h = 0; u > h; h++) {
        ...
        t.Noise.prototype.setType = function (t) {
            ...
            var t = e.audiocontext.currentTime, i = e.soundArray.indexOf(this);
    ...
    R = function () {
        ...
        e.inputSources = [], t.AudioIn = function (i) {
            ...
            if (i) {
                var n = i || 0, o = this.output.gain.value;
    ...
    j = function (t) {
        ...
        return t.Expr = function () {
            ...
            func: {
                abs: {regexp: /^abs/, method: i.bind(this, t.Abs)}, mod: {
                    regexp: /^mod/, method: function (e, i) {
                        var n = o(e[1]), r = new t.Modulo(n);
                        return i._eval(e[0]).connect(r), r
                    }
                }, pow: {
                    regexp: /^pow/, method: function (e, i) {
                        var n = o(e[1]), r = new t.Pow(n);
                        return i._eval(e[0]).connect(r), r
                    }
                }, a2g: {
                    regexp: /^a2g/, method: function (e, i) {
            ...
            binary: {
                ...
                "-": {
                    regexp: /^\-/, precedence: 1, method: function (n, o) {
            ...
            function i(e) {
                for (var i in t.Expr._Expressions) {
                    ...
                    for (var o in n) {
                        var r = n[o], s = r.regexp, a = e.match(s);
            ...
            function n(e, i, n) {
                var o = !1, r = t.Expr._Expressions[i];
            ...
            var c = this._tokenize(e), p = this.isUndef.bind(this);
            return o()
    ...
    Y = function () {
        ...
        return t.Effect = function () {
            ...
            var i = i || 0, n = n || 0, o = e.audiocontext.currentTime, r = this.output.gain.value;
    ...
    K = function () {
        ...
        t.Reverb = function () {
            ...
            var t, e, i = this.ac.sampleRate, n = i * this._seconds, o = this._decay, r = this.ac.createBuffer(2, n, i),
                s = r.getChannelData(0), a = r.getChannelData(1);
            ...
            var o = this, r = new t.Convolver(e, function (t) {
            ...
            var i = t.prototype._checkFileFormats(i), r = this, s = (new Error).stack,
                a = t.prototype.getAudioContext(), u = new XMLHttpRequest;
    ...
    it = function () {
        var e = a, i = et;
        t.Metro = function () {
            this.clock = new i({callback: this.ontick.bind(this)}), this.syncedParts = [], this.bpm = 120, this._init(), this.prevTick = 0, this.tatumTime = 0, this.tickCallback = function () {
            }
        }, t.Metro.prototype.ontick = function (t) {
            var i = t - this.prevTick, n = t - e.audiocontext.currentTime;
            if (!(i - this.tatumTime <= -.02)) {
                this.prevTick = t;
                var o = this;
                this.syncedParts.forEach(function (t) {
                    t.isPlaying && (t.incrementStep(n), t.phrases.forEach(function (t) {
                        var e = t.sequence, i = o.metroTicks % e.length;
            ...
            var n = 60 / (t * this.tatums), o = e.audiocontext.currentTime;
            this.tatumTime = n;
            var i = i || 0;
    ...
    ot = function () {
        ...
        return t.SoundLoop = function (t, n) {
            ...
            var n = i || 0, o = e.audiocontext.currentTime;
            if (t.isPlaying) {
                if (t.isPlaying) {
    ...
    var st;
    st = function () {
        var e = a, i = u.convertToWav, n = e.audiocontext;
        t.SoundRecorder = function () {
            this.input = n.createGain(), this.output = n.createGain(), this.recording = !1, this.bufferSize = 1024, this._channels = 2, this._clear(), this._jsNode = n.createScriptProcessor(this.bufferSize, this._channels, 2), this._jsNode.onaudioprocess = this._audioprocess.bind(this), this._callback = function () {
            }, this._jsNode.connect(t.soundOut._silentNode), this.setInput(), e.soundArray.push(this)
            ...
            if (this.recording !== !1 && this.recording === !0) if (this.sampleLimit && this.recordedSamples >= this.sampleLimit) this.stop(); else {
                var e = t.inputBuffer.getChannelData(0), i = t.inputBuffer.getChannelData(1);
            ...
            this._clear();
            var t = e.soundArray.indexOf(this);
            e.soundArray.splice(t, 1), this._callback = function () {
            }, this.input && this.input.disconnect(), this.input = null, this._jsNode = null
    ...
    var pt;
    pt = function () {
        var e = a, i = ct, n = u.noteToFreq, o = .15;
    ...
    ht = function () {
        ...
        t.PolySynth = function (n, o) {
            ...
            var a = e.audiocontext.currentTime, s = s || 0, u = a + s;
            ...
            var o = e.audiocontext.currentTime, r = i || 0, s = o + r;
            if (t) {
                var a = n(t);
